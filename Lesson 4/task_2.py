...
# CODUL TĂU VINE MAI JOS:
f_string = f"Salut, eu ma numesc {name}, dar toti imi spun {name2}!"
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(f_string.find("e"))
# CODUL TĂU VINE MAI SUS:

# Utilizând format string-uri, creează un string care să conțină variabilele `name` și `name2`

# CODUL TĂU VINE MAI JOS:
another_f_string = f"Hello, my name is {name} and everyone calls me {name2}!"
# CODUL TĂU VINE MAI SUS:

# Concatenează string-ul creat cu string-ul `text`

# CODUL TĂU VINE MAI JOS:
concatenated_string = f_string + another_f_string
# CODUL TĂU VINE MAI SUS:
